...
Backbone.ChildViewContainer = function (e, t) {
    ...
    t.extend(n.prototype, {add: function (e, t) {
        ...
        var r;
        n = n || [], t.each(this._views, function (r, i) {
        ...
        if (!e)return;
        var t, n, r = e.length;
        for (n = 0; n < r; n++)t = e[n], this.add(t)
    }});
    ...
    return r.Handlers = function (e, t) {
        ...
        return e.Handlers.extend({execute: function () {
        ...
        function r(e, r, i, s, o) {
            return o = o || e, n.call(e, r, i, t.bind(s, o))
        }

        function i() {
        }

        var n = e.Events.listenTo;
        return t.extend(i.prototype, e.Events, {listenTo: function (e, t, n, i) {
            return r(this, e, t, n, i)
        }}), i.extend = e.Model.extend, i
    }(e, n), r
...
var Marionette = function (e, t, n) {
    ...
    return r.extend = e.Model.extend, r.getOption = function (e, t) {
        ...
        function r(e) {
            e._isShown && e._isRendered && t.isFunction(e.triggerMethod) && e.triggerMethod("dom:refresh")
        }
        ...
        var r = e.Events.listenTo;
        t.addEventBinder = function (t) {
            !t.on && !t.off && !t.listenTo && !t.stopListening && n.extend(t, e.Events), t.listenTo = function (e, t, i, s) {
                return s = s || this, r.call(this, e, t, n.bind(i, s))
            }
        }
    }(e, r, t), r.EventAggregator = e.Wreqr.EventAggregator.extend({constructor: function () {
        r.addEventBinder(this);
        var t = Array.prototype.slice.apply(arguments);
        e.Wreqr.EventAggregator.prototype.constructor.apply(this, t)
    }}), function (e) {
        function n(e, n, r, i) {
            var s = i.split(/\s+/);
            t.each(s, function (t) {
        ...
        function o(e, n, r, i, s) {
            if (!n || !r)return;
            t.isFunction(r) && (r = r.call(e)), t.each(r, function (r, o) {
                t.isFunction(r) ? i(e, n, o, r) : s(e, n, o, r)
            })
        }

        e.bindEntityEvents = function (e, t, i) {
            o(e, t, i, r, n)
    ...
    }}), r.Region.extend = r.extend, r.TemplateCache = function (e) {
        this.templateId = e
        ...
        var e, t = Array.prototype.slice.apply(arguments), n = t.length;
        ...
        return i
    }}, r.View = e.View.extend({constructor: function () {
        t.bindAll(this, "render"), r.addEventBinder(this);
        var n = Array.prototype.slice.apply(arguments);
        e.View.prototype.constructor.apply(this, n), r.MonitorDOMRefresh(this), this.listenTo(this, "show", this.onShowCalled, this)
        ...
        return t.each(r, function (t, r) {
            n[r] = function (n) {
                n && n.preventDefault && n.preventDefault(), n && n.stopPropagation && n.stopPropagation();
                var r = {view: this, model: this.model, collection: this.collection};
                e.trigger(t, r)
            }
        }), n
        ...
        if (e === !1)return;
        this.isClosed = !0, this.triggerMethod("close"), this.remove()
    }, bindUIElements: function () {
        if (!this.ui)return;
        var e = this;
        this.uiBindings || (this.uiBindings = t.result(this, "ui")), this.ui = {}, t.each(t.keys(this.uiBindings), function (t) {
            var n = e.uiBindings[t];
            e.ui[t] = e.$(n)
        })
    }}), r.ItemView = r.View.extend({constructor: function () {
        var e = Array.prototype.slice.apply(arguments);
        r.View.prototype.constructor.apply(this, e)
        ...
        var e = Array.prototype.slice.apply(arguments);
        r.View.prototype.close.apply(this, e), this.triggerMethod("item:closed")
    }}), r.CollectionView = r.View.extend({itemViewEventPrefix: "itemview", constructor: function (e) {
        this._initChildViewStorage();
        var t = Array.prototype.slice.apply(arguments);
        r.View.prototype.constructor.apply(this, t), this._initialEvents()
        ...
        return t
    }, addItemView: function (e, n, i) {
        var s = this, o = r.getOption(this, "itemViewOptions");
        t.isFunction(o) && (o = o.call(this, e));
        var u = this.buildItemView(e, n, o);
        this.addChildViewEventForwarding(u), this.triggerMethod("before:item:added", u), this.children.add(u), this._isShown && r.triggerMethod.call(u, "show");
        var a = this.renderItemView(u, i);
        this.triggerMethod("after:item:added", u)
        ...
        e && (this.stopListening(e), e.close && e.close(), this.children.remove(e)), (!this.collection || this.collection.length === 0) && this.showEmptyView(), this.triggerMethod("item:removed", e)
        ...
        if (this.isClosed)return;
        this.triggerMethod("collection:before:close"), this.closeChildren(), this.triggerMethod("collection:closed");
        var e = Array.prototype.slice.apply(arguments);
        r.View.prototype.close.apply(this, e)
        ...
        var t = Array.prototype.slice.apply(arguments);
        r.CollectionView.apply(this, t), this.itemView = this.getItemView()
    }, _initialEvents: function () {
        this.collection && (this.listenTo(this.collection, "add", this.addChildView, this), this.listenTo(this.collection, "remove", this.removeItemView, this), this.listenTo(this.collection, "reset", this.renderCollection, this))
    }, getItemView: function (e) {
        ...
        var e = Array.prototype.slice.apply(arguments);
        r.CollectionView.prototype.render.apply(this, e), this.triggerMethod("composite:collection:rendered")
        ...
        this._firstRender = !0, this.initializeRegions();
        var e = Array.prototype.slice.apply(arguments);
        r.ItemView.apply(this, e)
    }, render: function () {
        ...
        if (this.isClosed)return;
        this.closeRegions(), this.destroyRegions();
        var e = Array.prototype.slice.apply(arguments);
        ...
        var n = Array.prototype.slice.apply(arguments);
        e.Router.prototype.constructor.apply(this, n), this.options = t;
        if (this.appRoutes) {
            var i = r.getOption(this, "controller");
        ...
        this.moduleName = e, this.submodules = {}, this._setupInitializersAndFinalizers(), this.app = t, this.startWithParent = !0, r.addEventBinder(this), this.triggerMethod = r.triggerMethod
        ...
        t.each(this.submodules, function (t) {
            var n = !0;
            n = t.startWithParent, n && t.start(e)
        }), this.triggerMethod("before:start", e), this._initializerCallbacks.run(e, this), this._isInitialized = !0, this.triggerMethod("start", e)
    }, stop: function () {
        if (!this._isInitialized)return;
        this._isInitialized = !1, r.triggerMethod.call(this, "before:stop"), t.each(this.submodules, function (e) {
            e.stop()
        }), this._finalizerCallbacks.run(), this._initializerCallbacks.reset(), this._finalizerCallbacks.reset(), r.triggerMethod.call(this, "stop")
    }, addDefinition: function (e, t) {
        this._runModuleDefinition(e, t)
    }, _runModuleDefinition: function (i, s) {
        if (!i)return;
        var o = t.flatten([this, this.app, e, r, n, t, s]);
        i.apply(this, o)
        ...
        var s = this, o = e, u = i.apply(arguments);
        u.splice(0, 3), n = n.split(".");
        var a = n.length, f = [];
        return f[a - 1] = r, t.each(n, function (t, n) {
            var r = o;
            o = s._getModule(r, t, e), s._addModuleDefinition(r, o, f[n], u)
        }), o
    }, _getModule: function (e, t, n, i, s) {
        var o = e[t];
        return o || (o = new r.Module(t, n), e[t] = o, e.submodules[t] = o), o
    }, _addModuleDefinition: function (e, n, r, i) {
        var s, o;
        t.isFunction(r) ? (s = r, o = !0) : t.isObject(r) ? (s = r.define, o = r.startWithParent) : o = !0, s && n.addDefinition(s, i);
        var u = n.startWithParent;
        n.startWithParent = n.startWithParent && o, n.startWithParent && !n.startWithParentIsConfigured && (n.startWithParentIsConfigured = !0, e.addInitializer(function (e) {
            n.startWithParent && n.start(e)
        }))
    }}), r
